...
//
//     final rocketDetailModel = rocketDetailModelFromJson(jsonString);

import 'dart:convert';

RocketDetailModel rocketDetailModelFromJson(String str) =>
    RocketDetailModel.fromJson(json.decode(str));

String rocketDetailModelToJson(RocketDetailModel data) =>
